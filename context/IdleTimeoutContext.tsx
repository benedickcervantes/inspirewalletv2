...
const INACTIVITY_LIMIT_MS = 15 * 1000; // 15 seconds (for testing – change back to 10 * 60 * 1000 for production)
const CHECK_INTERVAL_MS = 1000; // 1 second (for testing – change back to 60 * 1000 for production)
