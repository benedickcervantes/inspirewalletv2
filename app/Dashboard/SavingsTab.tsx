...
export default function SavingsTab({ userData, timeDeposit, formatCurrency }: SavingsTabProps) {
  const [depositData] = useState<{ month: string; amount: number }[]>([
      ...
      <View style={styles.amountWalletContainer}>
        <View style={styles.amountWalletCard}>
          <View style={styles.amountWalletContent}>
            <View style={styles.amountWalletLeft}>
              ...
              <Text style={styles.amountWalletAmount}>
                PHP {formatCurrency(timeDeposit * 0.31)}
              </Text>
            </View>
          ...
          <Ionicons
            ...
            size={20}
            color="#333"
            style={styles.amountWalletArrow}
          />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  amountWalletArrow: { marginLeft: 8 },
  ...
  servicesContainer: { paddingHorizontal: 20, paddingTop: 16 },
  servicesTitle: { fontSize: 16, fontWeight: "700", color: "#333", marginBottom: 16 },
  servicesGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
  ...
  serviceItem: { width: (width - 80) / 3, alignItems: "center", marginBottom: 20 },
  serviceColumn: { width: (width - 80) / 3, alignItems: "center" },
  serviceIcon: {
    width: 56,
    height: 56,
    borderRadius: 12,
