...
const SAMPLE_WALLET_ADDRESS = "bc1qf2kdgu2vlctqlnlxk4smkxd68grl5q2we8dzfd";
const SUPPORT_NOTE =
  "Note: This is a Native SegWit(bech32) address. Supported by: Binance, Coinbase, Trust Wallet, Ledger, Trezor, OKX, Bybit, KuCoin, Kraken, Bitsfamp, Bitfinex, Exodus, BlueWallet, Muun, Phoenix, Breez, Electrum, Sparrow Wallet, Wasabi Wallet.";
...
export default function DepositCrypto() {
  ...
  const handleCopyAddress = async () => {
    try {
      await Clipboard.setStringAsync(SAMPLE_WALLET_ADDRESS);
