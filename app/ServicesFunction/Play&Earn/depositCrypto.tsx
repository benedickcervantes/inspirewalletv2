...
const MOCK_DATA = {
  walletAddress: "bc1qf2kdgu2vlctqlnlxk4smkxd68grl5q2we8dzfd",
  accountName: "Aries Dev",
  accountEmail: "Aries_dev@gmail.com",
  supportNote: "Note: This is a Native SegWit(bech32) address. Supported by: Binance, Coinbase, Trust Wallet, Ledger, Trezor, OKX, Bybit, KuCoin, Kraken, Bitsfamp, Bitfinex, Exodus, BlueWallet, Muun, Phoenix, Breez, Electrum, Sparrow Wallet, Wasabi Wallet."
};
        ...
        >
          ...
          <View style={[styles.profileCard, isXSScreen && styles.cardCompact]}>
            ...
            <View style={styles.profileInfo}>
              <Text style={[styles.profileName, isXSScreen && styles.textCompact]}>{accountName}</Text>
              <Text style={[styles.profileEmail, isXSScreen && styles.textCompact]}>{accountEmail}</Text>
            </View>
            ...
            {CRYPTO_OPTIONS.map((crypto) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.cryptoPill,
                    isActive && styles.cryptoPillActive,
                  ]}
                  onPress={() => {
                    if (crypto.id === "ETH") {
                ...
                >
                  <View style={[
                    ...
                    isActive && styles.cryptoPillIconCircleActiveBtc,
                  ]}>
                    <Ionicons
                      name={crypto.icon}
                      size={18}
          ...
          <View style={[styles.walletCard, isXSScreen && styles.cardCompact]}>
            <View style={styles.walletCardRow}>
              ...
              <View style={styles.walletAddressSection}>
                <Text style={[styles.walletLabel, isXSScreen && styles.textCompact]}>Wallet Address</Text>
                <Text style={[styles.walletAddress, isXSScreen && styles.textCompact]} numberOfLines={2}>
