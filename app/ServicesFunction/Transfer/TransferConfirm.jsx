...
export const processTransfer = async (
  ...
  try {
    ...
    if (balanceType === "available") {
      senderBalance = senderData.balance || senderData.availBalanceAmount || 0;
    } else {
      senderBalance = senderData.agentWallet || senderData.agentWalletAmount || 0;
    }
...
export const fetchCurrentBalance = async (userId, balanceType) => {
  try {
...
export default function TransferConfirm() {
  ...
  const description = route.params?.description || "N/A";
