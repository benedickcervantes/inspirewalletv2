...
export const fetchUserBalances = async () => {
  try {
    ...
    return {
      availableBalance: userData.balance || userData.availBalanceAmount || 0,
      agentWallet: userData.agentWallet || userData.agentWalletAmount || 0,
      userData,
    };
  } catch (error) {
...
export const validateBalanceSelection = (selectedBalance, agentWallet) => {
  if (!selectedBalance) {
    return {
      isValid: false,
...
export const checkSufficientBalance = (balanceType, availableBalance, agentWallet, amount) => {
...
export default function SendMoney() {
  ...
  const loadBalances = async () => {
    try {
      ...
      setAgentWallet(balances.agentWallet);
    } catch (error) {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate("TransferRecipient", { balanceType: selectedBalance });
  };
