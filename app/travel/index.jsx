...
export default function TravelProtection() {
  ...
  const handleNext = () => {
    if (currentStep === 1) {
      ...
      if (!destinationAddress || checkInDateText === "Select check-in date" || !duration || !airline || 
          departureTimeText === "Select departure time" || arrivalTimeText === "Select arrival time" || 
          !passportNumber || !purposeOfTravel) {
        showAlert("Required Fields", "Please fill in all required fields", "error");
        return;
      }
      setCurrentStep(5);
            ...
            >
              ...
              <View style={styles.feeCard}>
                ...
                <Text style={styles.feeSubtext}>
                  {userTimeDeposit > 0 ? "DISCOUNTED RATE (TIME DEPOSIT HOLDER)" : "STANDARD PROTECTION RATE"}
                </Text>
              </View>
              ...
              <View style={styles.formCard}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={[styles.dropdownText, dateOfBirthText === "Select your birthdate" && styles.dropdownPlaceholder]}>
                      {dateOfBirthText}
                    </Text>
              ...
              <View style={styles.formCard}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={[styles.dropdownText, checkInDateText === "Select check-in date" && styles.dropdownPlaceholder]}>
                      {checkInDateText}
                    </Text>
                    <Ionicons name="calendar" size={20} color="#666" />
                  </TouchableOpacity>
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={[styles.dropdownText, departureTimeText === "Select departure time" && styles.dropdownPlaceholder]}>
                      {departureTimeText}
                    </Text>
                ...
                <View style={styles.inputGroup}>
                  ...
                  >
                    <Text style={[styles.dropdownText, arrivalTimeText === "Select arrival time" && styles.dropdownPlaceholder]}>
                      {arrivalTimeText}
                    </Text>
                    <Ionicons name="time" size={20} color="#666" />
                  </TouchableOpacity>
