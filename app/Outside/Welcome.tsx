...
export default function Welcome() {
  ...
  const [showStartup, setShowStartup] = useState(
    !hasShownStartupLoaderThisSession,
  );
  ...
  return (
    <>
      ...
      >
        ...
        <View
          style={[styles.welcomeContent, isShortScreen && { marginTop: -40 }]}
        >
          <Image
          ...
          <View style={[styles.actions, isSmallScreen && { maxWidth: 280 }]}>
            ...
            >
              <Text
                style={[
                  styles.buttonText,
                  (isSmallScreen || isShortScreen) && { fontSize: 16 },
                ]}
              >
                {t("auth.register")}
              </Text>
        ...
        <Text style={[styles.footer, isShortScreen && { paddingBottom: 16 }]}>
          {t("auth.createdByInspire")}
        </Text>
      </LinearGradient>
        ...
        >
          ...
          >
            <View style={welcomeLanguageStyles.header}>
              ...
              <Text
                style={[
                  welcomeLanguageStyles.subtitle,
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      language === label &&
                        welcomeLanguageStyles.optionTextSelected,
                    ]}
                  >
                    {label}
                  </Text>
            ...
            <TouchableOpacity
              style={[
                welcomeLanguageStyles.cancelBtn,
            ...
            >
              <Text
                style={[
                  welcomeLanguageStyles.cancelText,
                  isSmallScreen && { fontSize: 15 },
                ]}
              >
                {t("common.cancel")}
