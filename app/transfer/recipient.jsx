      ...
      if (user) {
        ...
        if (userDoc.exists()) {
          ...
          if (balanceType === "available") {
            ...
            setAvailableBalance(userData.agentWallet || userData.agentWalletAmount || 0);
          }
        }
      }
    } catch (error) {
    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputSection}>
              ...
              <Text style={styles.availableText}>
                Available: PHP {availableBalance.toLocaleString("en-PH", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </Text>
            </View>
          ...
          {/* Continue Button */}
          <TouchableOpacity
            style={[styles.continueButton, (!accountNumber || !amount) && styles.continueButtonDisabled]}
            onPress={handleContinue}
            disabled={!accountNumber || !amount || isLoading}
          >
            <LinearGradient
              colors={(!accountNumber || !amount) ? ["#CCC", "#999"] : ["#E25A17", "#F28934"]}
