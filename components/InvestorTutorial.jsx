...
const InvestorTutorial = ({ visible, onClose }) => {
  const [currentIndex, setCurrentIndex] = useState(0);
  
  const tutorialImages = [
    require("../assets/tutorial/investor/2.png"),
    require("../assets/tutorial/investor/3.png"),
    require("../assets/tutorial/investor/4.png"),
    require("../assets/tutorial/investor/5.png"),
    require("../assets/tutorial/investor/6.png"),
  ];
  ...
  const tutorialDescriptions = [
    "Learn how to Register as Investor in Inspire Wallet",
    "Click the Register button",
    "Enter your First name and Last name",
    "Click 'No, I'm an Investor' since you are an investor",
    "You're all set! Click 'Create Account' and Start your investment journey today",
  ];
...
export default InvestorTutorial; 