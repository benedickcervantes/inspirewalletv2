...
const en: TranslationMap = {
  ...
  "pcard.subtitle": "View your Inspire Card front and back — tap to flip.",
  "pcard.hint":
  ...
  "pcard.exclusiveBody1":
    "Inspire Card is a premium membership experience inside Inspire Wallet — bringing card services together with your deposits, time deposits, stock investing, transfers, Play & Earn, and e-wallet tools in one secure place.",
  "pcard.exclusiveBody2":
    "Entering new markets or financial products without clear guidance can involve real risk. Inspire Card membership is designed to give you priority support and structured access so you can use Inspire Wallet services with greater clarity and confidence.",
...
const ja: TranslationMap = {
  ...
  "ct.needDepositStatus": "定期預金に10,000,000ペソ以上必要です",
  "ct.gotIt": "了解",
